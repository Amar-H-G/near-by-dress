...
const CampaignSection = () => {
  ...
  const campaigns = settings?.campaigns?.length ? settings.campaigns : [
    {
      ...
      <div className="container">
        ...
        <div className="fashion-campaign-grid">
          {campaigns.map((campaign) => (
            <Link key={campaign.title} to={campaign.to || '/products'} className="fashion-campaign-card">
              {campaign.image && <img src={campaign.image} alt="" loading="lazy" />}
